...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://zt-travel.sa/" },
    ],
    links: [{ rel: "canonical", href: "https://zt-travel.sa/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: "https://zt-travel.sa/brand-logo.png",
          email: BRAND.email,
          telephone: `+${BRAND.whatsapp}`,
          identifier: BRAND.nationalNumber,
          address: { "@type": "PostalAddress", addressCountry: "SA", addressLocality: "المدينة المنورة" },
          areaServed: ["المدينة المنورة", "مكة المكرمة"],
        }),
      },
    ],
  }),
