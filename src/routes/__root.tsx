...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "احجز رحلتك للعمرة من المدينة المنورة إلى مكة المكرمة بأعلى درجات الراحة والموثوقية مع مؤسسة زهرة طيبة." },
      ...
      { property: "og:description", content: "احجز رحلتك للعمرة من المدينة المنورة إلى مكة المكرمة بأعلى درجات الراحة والموثوقية مع مؤسسة زهرة طيبة." },
      { name: "twitter:description", content: "احجز رحلتك للعمرة من المدينة المنورة إلى مكة المكرمة بأعلى درجات الراحة والموثوقية مع مؤسسة زهرة طيبة." },
