          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/70 text-sm">
                إدارة جميع إعدادات النظام والموقع
              </p>
          ...
          >
            ...
            <div className="grid gap-5">
              ...
              <div className="rounded-xl bg-muted p-4 text-sm text-muted-foreground">
                ...
                أما الأقسام الأخرى مثل رحلة الحجز والسحب والإحصائيات فهي تُدار
                من صفحاتها الخاصة لأنها ليست محتوى ثابتًا.
            ...
            <div className="grid gap-5">
              ...
              <div className="rounded-xl border bg-muted/40 p-4">
                ...
                <p className="text-sm text-muted-foreground leading-7">
                  ...
                  جميع الرسائل الموجودة هنا سيتم استخدامها في صفحات الحجز
                  بدلاً من كتابة النصوص داخل الكود، مما يسمح بتعديلها من لوحة
                  التحكم دون الحاجة إلى إعادة نشر الموقع.
