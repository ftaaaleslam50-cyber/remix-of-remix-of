ALTER TABLE public.trips ADD COLUMN IF NOT EXISTS clone_buses_on_advance boolean NOT NULL DEFAULT false;
ALTER TABLE public.buses ALTER COLUMN bus_number SET DEFAULT 0;
      ...
      IF t.clone_buses_on_advance THEN
        ...
        LOOP
          INSERT INTO public.buses (
            ...
            price_addition, round_trip_price, outbound_price, return_price, direction,
            ...
            old_bus.price_addition, old_bus.round_trip_price, old_bus.outbound_price, old_bus.return_price,
