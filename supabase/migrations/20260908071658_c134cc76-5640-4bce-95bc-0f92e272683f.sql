ALTER TABLE public.buses DROP CONSTRAINT IF EXISTS buses_trip_id_bus_number_key;
DROP INDEX IF EXISTS public.buses_trip_id_bus_number_key;
CREATE UNIQUE INDEX buses_trip_id_bus_number_key ON public.buses (trip_id, bus_number) WHERE bus_number <> 0;
